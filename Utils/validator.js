...
module.exports = {
    validators: [
        ...
        body('fullName').matches(/^[A-Za-zÀ-ỹ\s]+$/).withMessage('Họ tên chỉ được chứa chữ cái và khoảng trắng'),
        body('avatarUrl').isURL().withMessage('Avatar URL phải là một đường dẫn hợp lệ')
    ],
